...
const styles: Record<string, React.CSSProperties> = {
  ...
  roomCodeLabel: { fontSize: 10, color: COLORS.textMuted, letterSpacing: '3px', margin: 0 },
  ...
  sectionLabel: { fontSize: 10, color: COLORS.textMuted, letterSpacing: '3px', fontWeight: '600', margin: 0 },
  ...
  charCardName: { fontSize: 10, color: COLORS.textPrimary, textAlign: 'center', fontWeight: '600', lineHeight: '1.2' },
  charCardAlignment: { fontSize: 8, letterSpacing: '1px', fontWeight: '700' },
  ...
  fillerAlignment: { fontSize: 9, letterSpacing: '1px', fontWeight: '700' },
