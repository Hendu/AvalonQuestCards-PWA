...
.forEach(function(check) {
    ...
    if (typeof version === "string" && version.charAt(0) !== pkg.versionScheme)
        process.stderr.write(pkg.name + " " + warn + " " + pkg.name + "***REMOVED*** + version + " is configured as a dependency of " + basePkg.name + ". use " + pkg.name + "***REMOVED*** + pkg.versionScheme + version.substring(1) + " instead for API compatibility.\n");
});
